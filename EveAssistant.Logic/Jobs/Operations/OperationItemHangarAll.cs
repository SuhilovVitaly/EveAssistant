...
{
    public class OperationItemHangarAll
    {
        private const string Pattern = @"ItemHangar/FilterAllDesabled";
        private const string PatternFilterAll = @"ItemHangar/FilterFlmEnabled";
